...
# cross-section | Width(D) mm | Weight kg/m
...
cab_lst.append(["2 runs of 3-#70, 1-#70", 81.2, 7.3])
...
cab_lst.append(["2 runs of 3-#120, 1-#70", 88, 9.56])
cab_lst.append(["3 runs of 3-#120, 1-#70", 132, 14.34])
...
cab_lst.append(["5 runs of 3-#120, 1-#120 mm, 1-#70", 250, 33.7])
cab_lst.append(["6 runs of 3-#120, 1-#120 mm, 1-#70", 300, 40.44])

cab_lst.append(["3-#150, 1-#70", 48.5, 5.87])
cab_lst.append(["2 runs of 3-#150, 1-#70", 97, 11.74])
cab_lst.append(["3 runs of 3-#150, 1-#70", 145.5, 17.61])
cab_lst.append(["4 runs of 3-#150, 1-#70", 194, 23.48])
cab_lst.append(["5 runs of 3-#150, 1-#70", 242.5, 29.35])
...
cab_lst.append(["3 runs of 3-#150, 1-#150 mm, 1-#70", 168, 23.97])
...
cab_lst.append(["LAN 250 (S/FTP)", 6.8, 0.055])
cab_lst.append(["LAN 250 (U/UTP)", 6.8, 0.095])
